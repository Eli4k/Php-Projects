      ...
      <div class="card-body">
        <form action="includes/signup.inc.php" method="POST">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <div class="form-label-group">
              <input type="text" name="uname" id="userName" class="form-control" placeholder="Username" required="required">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" name="rpassword" id="confirmPassword" class="form-control" placeholder="Confirm password" required="required">
                  <label for="confirmPassword">Confirm password</label>
                </div>
              </div>
            </div>
          </div>
          <input type="submit" name="register" class="btn btn-primary btn-block" value="Register Account">
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="pages/login.php">Login Page</a>
          <a class="d-block small" href="pages/forgot-password.php">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
